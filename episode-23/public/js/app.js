...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_ProjectList_vue__ = __webpack_require__(41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lib_Form__ = __webpack_require__(45);
...
window.Form = __WEBPACK_IMPORTED_MODULE_3__lib_Form__["a" /* default */];

new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    el: '#app',

    components: {
        ProjectList: __WEBPACK_IMPORTED_MODULE_2__components_ProjectList_vue___default.a
    },

    data: {
        form: new __WEBPACK_IMPORTED_MODULE_3__lib_Form__["a" /* default */]({
            name: '',
            description: ''
        }),
        projects: []
    ...
    methods: {
        onSubmit: function onSubmit() {
            ...
            var initialData = this.form.data();
            this.form.post('/projects').then(function (data) {
                _this.projects.push(initialData);
            });
        }
    }
      ...
      directives: [
        {
          name: "show",
          rawName: "v-show",
          value: _vm.projects.length > 0,
          expression: "projects.length > 0"
        }
      ]
    },
    [
      _c("h1", { staticClass: "title is-3" }, [_vm._v("My Projects")]),
      _vm._v(" "),
      _c(
        "ul",
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Errors__ = __webpack_require__(58);
...
module.exports = !__webpack_require__(1) && !__webpack_require__(16)(function () {
